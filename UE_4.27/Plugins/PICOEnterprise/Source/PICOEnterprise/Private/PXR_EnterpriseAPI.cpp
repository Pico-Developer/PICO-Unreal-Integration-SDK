...
bool UPICOXRSystemAPI::PXR_SetSystemAutoSleepTime(ESleepDelayTimeEnum TimeEnum)
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
FPICOEnterpriseIntDelegate UPICOXRSystemAPI::SwitchSystemFunctionDelegate;
void UPICOXRSystemAPI::PXR_SwitchSystemFunction(ESystemFunctionSwitchEnum SystemFunction, ESwitchEnum SwitchEnum, int32 Ext, FPICOEnterpriseIntDelegate Delegate)
{
...
{
	UPICOXRSystemAPI::SwitchSystemFunctionDelegate.ExecuteIfBound(Result);
}
#endif
...
bool UPICOXRSystemAPI::PXR_SetScreenBrightness(int Brightness, int Ext)
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
FPICOEnterpriseIntDelegate UPICOXRSystemAPI::SetWifiP2PDeviceNameDelegate;
void UPICOXRSystemAPI::PXR_SetWifiP2PDeviceName(const FString& DeviceName, int Ext, FPICOEnterpriseIntDelegate Delegate)
{
...
FString UPICOXRSystemAPI::PXR_GetWifiP2PDeviceName(int Ext)
{
	FString Result;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
bool UPICOXRSystemAPI::PXR_SetSystemKeyUsability(ESystemKey key, int Ext)
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
bool UPICOXRSystemAPI::PXR_SetLauncher(FString PackageName)
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
bool UPICOXRSystemAPI::PXR_OpenTimingStartup(int hour, int minute, int repeat)
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
bool UPICOXRSystemAPI::PXR_CloseTimingStartup()
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
bool UPICOXRSystemAPI::PXR_OpenTimingShutdown(int hour, int minute, int repeat)
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
bool UPICOXRSystemAPI::PXR_CloseTimingShutdown()
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
bool UPICOXRSystemAPI::PXR_SetTimeZone(FString TimeZone)
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
FPICOEnterpriseIntDelegate UPICOXRSystemAPI::AppCopyrightVerifyDelegate;
void UPICOXRSystemAPI::PXR_AppCopyrightVerify(FString PackageName, FPICOEnterpriseIntDelegate Delegate)
{
...
bool UPICOXRSystemAPI::PXR_GotoEnvironmentTextureCheck()
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
int UPICOXRSystemAPI::PXR_SetSystemDate(int year, int month, int day)
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
int UPICOXRSystemAPI::PXR_SetSystemTime(int hourOfDay, int minute, int second)
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
TArray<FString> UPICOXRSystemAPI::PXR_GetRunningAppProcesses()
{
	TArray<FString> Results;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
FString UPICOXRSystemAPI::PXR_GetFocusedApp()
{
	FString Result;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
int UPICOXRSystemAPI::PXR_CreateVirtualDisplay(FString displayName, int64 surface, int width, int height, int densityDpi, int flags)
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
int UPICOXRSystemAPI::PXR_SetVirtualDisplaySurface(int displayId, int64 surface)
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
int UPICOXRSystemAPI::PXR_ResizeVirtualDisplay(int displayId, int width, int height, int densityDpi)
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
int UPICOXRSystemAPI::PXR_InjectEventXY(int displayId, int action, int source, float x, float y)
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
int UPICOXRSystemAPI::PXR_InjectEventKeyCode(int displayId, int action, int source, int keycode)
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
int UPICOXRSystemAPI::PXR_StartApp(int displayId, FIntent Intent)
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
int UPICOXRSystemAPI::PXR_ReleaseVirtualDisplay(int displayId)
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
int UPICOXRSystemAPI::PXR_SetVirtualEnvironment(FString envPath)
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
FString UPICOXRSystemAPI::PXR_GetVirtualEnvironment()
{
	FString Result;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
FString UPICOXRSystemAPI::PXR_StartService(FIntent Intent)
{
	FString Result;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
FString UPICOXRSystemAPI::PXR_StartForegroundService(FIntent Intent)
{
	FString Result;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
int UPICOXRSystemAPI::PXR_SendBroadcast(FIntent Intent)
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
int UPICOXRSystemAPI::PXR_SendOrderedBroadcast(FIntent Intent, FString ReceiverPermission)
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
int UPICOXRSystemAPI::PXR_KeepAliveBackground(int keepAlivePid, int flags, int level)
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
int UPICOXRSystemAPI::PXR_OpenIPDDetectionPage()
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
int UPICOXRSystemAPI::PXR_SetFloorHeight(float height)
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
float UPICOXRSystemAPI::PXR_GetFloorHeight()
{
	float Result = 0.0f;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
FString UPICOXRSystemAPI::PXR_GetTimingStartupStatusTwo(int ext)
{
	FString Result;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
FString UPICOXRSystemAPI::PXR_GetTimingShutDownStatusTwo(int ext)
{
	FString Result;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
void UPICOXRSystemAPI::PXR_GetLargeSpaceBoundsInfo(TArray<FVector>& OutData)
{
#if PLATFORM_ANDROID
		if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
		{
...
FPICOEnterpriseIntDelegate UPICOXRSystemAPI::OpenLargeSpaceQuickModeDelegate;
void UPICOXRSystemAPI::PXR_OpenLargeSpaceQuickMode(int length, int width, int originType, bool openVst, float distance, int timeout, FPICOEnterpriseIntDelegate delegate)
{
...
{
	UPICOXRSystemAPI::OpenLargeSpaceQuickModeDelegate.ExecuteIfBound(Result);
}
#endif

void UPICOXRSystemAPI::PXR_CloseLargeSpaceQuickMode()
{
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
...
FPICOEnterpriseIntDelegate UPICOXRSystemAPI::SetOriginOfLargeSpaceQuickModeDelegate;
void UPICOXRSystemAPI::PXR_SetOriginOfLargeSpaceQuickMode(int originType, bool openVst, float distance, int timeout, FPICOEnterpriseIntDelegate delegate)
{
...
{
	UPICOXRSystemAPI::SetOriginOfLargeSpaceQuickModeDelegate.ExecuteIfBound(Result);
}
#endif

FPICOEnterpriseIntDelegate UPICOXRSystemAPI::SetBoundaryOfLargeSpaceQuickModeDelegate;
void UPICOXRSystemAPI::PXR_SetBoundaryOfLargeSpaceQuickMode(int length, int width, FPICOEnterpriseIntDelegate delegate)
{
...
{
	UPICOXRSystemAPI::SetBoundaryOfLargeSpaceQuickModeDelegate.ExecuteIfBound(Result);
}
#endif

void UPICOXRSystemAPI::PXR_GetLargeSpaceQuickModeInfo(TArray<int>& infor)
{
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
...
int UPICOXRSystemAPI::PXR_StartLeftControllerPair()
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
int UPICOXRSystemAPI::PXR_MakeLeftControllerUnPair()
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
int UPICOXRSystemAPI::PXR_StartRightControllerPair()
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
int UPICOXRSystemAPI::PXR_MakeRightControllerUnPair()
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
int UPICOXRSystemAPI::PXR_StopControllerPair()
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
int UPICOXRSystemAPI::PXR_SetControllerPreferHand(bool isLeft)
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
int UPICOXRSystemAPI::PXR_SetControllerVibrateAmplitude(int value)
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
int UPICOXRSystemAPI::PXR_SetPowerManageMode(int value)
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
int UPICOXRSystemAPI::PXR_StartRoomMark()
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
int UPICOXRSystemAPI::PXR_ClearRoomMark()
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
int UPICOXRSystemAPI::PXR_ClearEyeTrackData()
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
int UPICOXRSystemAPI::PXR_SetEyeTrackRate(int value)
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
int UPICOXRSystemAPI::PXR_SetTrackFrequency(int value)
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
int UPICOXRSystemAPI::PXR_StartSetSecureBorder()
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
int UPICOXRSystemAPI::PXR_SetDistanceSensitivity(int value)
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
int UPICOXRSystemAPI::PXR_SetSpeedSensitivity(int value)
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
int UPICOXRSystemAPI::PXR_SetMotionTrackerPredictionCoefficient(float predictionCoefficient)
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
float UPICOXRSystemAPI::PXR_GetMotionTrackerPredictionCoefficient()
{
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
...
int UPICOXRSystemAPI::PXR_StartMotionTrackerApp(int failMode, int avatarMode)
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
int UPICOXRSystemAPI::PXR_SetSingleEyeSource(bool isLeft)
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
int UPICOXRSystemAPI::PXR_SetViewVisual(int mode)
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
int UPICOXRSystemAPI::PXR_SetAcceptCastMode(int mode)
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
int UPICOXRSystemAPI::PXR_SetScreenCastMode(int mode)
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
int UPICOXRSystemAPI::PXR_SetScreenRecordShotRatio(int mode)
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
int UPICOXRSystemAPI::PXR_SetScreenResolution(int width, int height)
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
int UPICOXRSystemAPI::PXR_SetScreenRecordFrameRate(int value)
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
int UPICOXRSystemAPI::PXR_ShowGlobalMessageDialog(UTexture2D* icon, FString title, FString body, int64 time, int gap, int position)
{
	int Result = INT_MAX;
...
void UPICOXRSystemAPI::PXR_HideGlobalMessageDialog()
{
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
...
int UPICOXRSystemAPI::PXR_ShowGlobalTipsDialog(UTexture2D* icon, FString title, int64 time, int position, int bgColor)
{
	int Result = INT_MAX;
	FByteBulkData* RawImageData = nullptr;
	int ImageWidth = 0;
...
void UPICOXRSystemAPI::PXR_HideGlobalTipsDialog()
{
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
...
int UPICOXRSystemAPI::PXR_ShowGlobalBigStatusDialog(UTexture2D* icon, FString title, FString body, int64 time, int gap, int position)
{
	int Result = INT_MAX;
	FByteBulkData* RawImageData = nullptr;
	int ImageWidth = 0;
...
void UPICOXRSystemAPI::PXR_HideGlobalBigStatusDialog()
{
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
...
int UPICOXRSystemAPI::PXR_ShowGlobalSmallStatusDialog(UTexture2D* icon, FString title, int64 time, int gap, int position)
{
	int Result = INT_MAX;
	FByteBulkData* RawImageData = nullptr;
	int ImageWidth = 0;
...
void UPICOXRSystemAPI::PXR_HideGlobalSmallStatusDialog()
{
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
...
int UPICOXRSystemAPI::PXR_ShowGlobalDialogByType(FString type, UTexture2D* icon, FString title, FString body, int64 time, int gap, int position, int bgColor)
{
	int Result = INT_MAX;
	FByteBulkData* RawImageData = nullptr;
	int ImageWidth = 0;
...
void UPICOXRSystemAPI::PXR_HideGlobalDialogByType(FString type)
{
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
...
FPICOOnUpdateStatusChangedDelegate UPICOXRSystemAPI::OnfflineUpdateStatusChangedDelegate;
FPICOOnUpdateCompleteDelegate UPICOXRSystemAPI::OnfflineUpdateCompleteDelegate;
int UPICOXRSystemAPI::PXR_OfflineSystemUpdate(FString OtaFilePath, bool AutoReboot, bool ShowProgress, const FPICOOnUpdateStatusChangedDelegate& UpdateStatusChangedDelegate, const FPICOOnUpdateCompleteDelegate& UpdateCompleteDelegate)
{
...
int UPICOXRSystemAPI::PXR_Recenter()
{
	int Result = INT_MAX;
#if PLATFORM_ANDROID
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
...
FPICOEnterpriseStringDelegate UPICOXRSystemAPI::EnterpriseStringDelegate;
void UPICOXRSystemAPI::PXR_ScanQRCode(const FPICOEnterpriseStringDelegate& Delegate)
{
...
{
	UPICOXRSystemAPI::EnterpriseStringDelegate.ExecuteIfBound(FJavaHelper::FStringFromParam(env, Msg));
}
#endif
...
{
	UPICOXRSystemAPI::OnfflineUpdateStatusChangedDelegate.ExecuteIfBound(statusCode, percent);
}
...
{
	UPICOXRSystemAPI::OnfflineUpdateCompleteDelegate.ExecuteIfBound(errorCode, FJavaHelper::FStringFromParam(env, errorMsg));
}
#endif // PLATFORM_ANDROID

FPICOOnUpdateStatusChangedDelegate UPICOXRSystemAPI::OnUpdateStatusChangedDelegate;
FPICOOnUpdateCompleteDelegate UPICOXRSystemAPI::OnUpdateCompleteDelegate;
int UPICOXRSystemAPI::PXR_OnlineSystemUpdate(const FPICOOnUpdateStatusChangedDelegate& UpdateStatusChangedDelegate, const FPICOOnUpdateCompleteDelegate& UpdateCompleteDelegate)
{
...
{
	UPICOXRSystemAPI::OnUpdateStatusChangedDelegate.ExecuteIfBound(statusCode, percent);
}
...
{
	UPICOXRSystemAPI::OnUpdateCompleteDelegate.ExecuteIfBound(errorCode, FJavaHelper::FStringFromParam(env, errorMsg));
}
#endif // PLATFORM_ANDROID
...
{
	UPICOXRSystemAPI::AppCopyrightVerifyDelegate.ExecuteIfBound(Result);
}
#endif // PLATFORM_ANDROID
...
{
	UPICOXRSystemAPI::SetWifiP2PDeviceNameDelegate.ExecuteIfBound(Result);
}
#endif // PLATFORM_ANDROID
