...
/// @endcond
	...
	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	bool PXR_SetSystemAutoSleepTime(ESleepDelayTimeEnum TimeEnum);
	...
	/// <returns>None</returns>
	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	void PXR_SwitchSystemFunction(ESystemFunctionSwitchEnum SystemFunction, ESwitchEnum SwitchEnum, int32 Ext, FPICOEnterpriseIntDelegate Delegate);
	...
	/// <returns>(Out) bool, Result</returns>
	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	bool PXR_SetScreenBrightness(int Brightness, int Ext);
	...
	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	void PXR_SetWifiP2PDeviceName(const FString& DeviceName, int Ext, FPICOEnterpriseIntDelegate Delegate);

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	FString PXR_GetWifiP2PDeviceName(int Ext);

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
    bool PXR_SetSystemKeyUsability(ESystemKey key, int Ext);

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	bool PXR_SetLauncher(FString PackageName);

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	bool PXR_OpenTimingStartup(int hour, int minute, int repeat);

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	bool PXR_CloseTimingStartup();

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	bool PXR_OpenTimingShutdown(int hour, int minute, int repeat);

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	bool PXR_CloseTimingShutdown();

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	bool PXR_SetTimeZone(FString TimeZone);

	static FPICOEnterpriseIntDelegate AppCopyrightVerifyDelegate;
	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	void PXR_AppCopyrightVerify(FString PackageName, FPICOEnterpriseIntDelegate Delegate);

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	bool PXR_GotoEnvironmentTextureCheck();

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_SetSystemDate(int year, int month, int day);

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_SetSystemTime(int hourOfDay, int minute, int second);

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	TArray<FString> PXR_GetRunningAppProcesses();

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	FString PXR_GetFocusedApp();
	
	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_CreateVirtualDisplay(FString displayName, int64 surface, int width, int height, int densityDpi, int flags);
	
	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_SetVirtualDisplaySurface(int displayId, int64 surface);

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_ResizeVirtualDisplay(int displayId, int width, int height, int densityDpi);
	
	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_InjectEventXY(int displayId, int action, int source, float x, float y);

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_InjectEventKeyCode(int displayId, int action, int source, int keycode);

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_StartApp(int displayId, FIntent Intent);

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_ReleaseVirtualDisplay(int displayId);

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_SetVirtualEnvironment(FString envPath);

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	FString PXR_GetVirtualEnvironment();

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	FString PXR_StartService(FIntent Intent);

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	FString PXR_StartForegroundService(FIntent Intent);

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_SendBroadcast(FIntent Intent);

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_SendOrderedBroadcast(FIntent Intent, FString ReceiverPermission);

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_KeepAliveBackground(int keepAlivePid, int flags, int level);

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_OpenIPDDetectionPage();

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_SetFloorHeight(float height);

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	float PXR_GetFloorHeight();

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	FString PXR_GetTimingStartupStatusTwo(int ext);

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	FString PXR_GetTimingShutDownStatusTwo(int ext);
	
	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	void PXR_GetLargeSpaceBoundsInfo(TArray<FVector>& Points);
	
	static FPICOEnterpriseIntDelegate OpenLargeSpaceQuickModeDelegate;
	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	void PXR_OpenLargeSpaceQuickMode(int length, int width, int originType, bool openVst, float distance, int timeout, FPICOEnterpriseIntDelegate delegate);

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	void PXR_CloseLargeSpaceQuickMode();

	static FPICOEnterpriseIntDelegate SetOriginOfLargeSpaceQuickModeDelegate;
	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	void PXR_SetOriginOfLargeSpaceQuickMode(int originType, bool openVst, float distance, int timeout, FPICOEnterpriseIntDelegate delegate);


	static FPICOEnterpriseIntDelegate SetBoundaryOfLargeSpaceQuickModeDelegate;
	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	void PXR_SetBoundaryOfLargeSpaceQuickMode(int length, int width, FPICOEnterpriseIntDelegate delegate);

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	void PXR_GetLargeSpaceQuickModeInfo(TArray<int>& infor);

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_StartLeftControllerPair();

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_MakeLeftControllerUnPair();

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_StartRightControllerPair();

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_MakeRightControllerUnPair();

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_StopControllerPair();

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_SetControllerPreferHand(bool isLeft);

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_SetControllerVibrateAmplitude(int value);

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_SetPowerManageMode(int value);

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_StartRoomMark();

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_ClearRoomMark();

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_ClearEyeTrackData();

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_SetEyeTrackRate(int value);

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_SetTrackFrequency(int value);

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_StartSetSecureBorder();

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_SetDistanceSensitivity(int value);

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_SetSpeedSensitivity(int value);

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_SetMotionTrackerPredictionCoefficient(float predictionCoefficient);

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	float PXR_GetMotionTrackerPredictionCoefficient();

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_StartMotionTrackerApp(int failMode, int avatarMode);

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_SetSingleEyeSource(bool isLeft);

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_SetViewVisual(int mode);

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_SetAcceptCastMode(int mode);

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_SetScreenCastMode(int mode);

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_SetScreenRecordShotRatio(int mode);

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_SetScreenResolution(int width, int height);

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_SetScreenRecordFrameRate(int value);

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_ShowGlobalMessageDialog(UTexture2D* icon, FString title, FString body, int64 time, int gap, int position);
	
	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	void PXR_HideGlobalMessageDialog();

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_ShowGlobalTipsDialog(UTexture2D* icon, FString title, int64 time, int position, int bgColor);

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	void PXR_HideGlobalTipsDialog();

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_ShowGlobalBigStatusDialog(UTexture2D* icon, FString title, FString body, int64 time, int gap, int position);

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	void PXR_HideGlobalBigStatusDialog();

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_ShowGlobalSmallStatusDialog(UTexture2D* icon, FString title, int64 time, int gap, int position);

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	void PXR_HideGlobalSmallStatusDialog();

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_ShowGlobalDialogByType(FString type, UTexture2D* icon, FString title, FString body, int64 time, int gap, int position, int bgColor);

	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	void PXR_HideGlobalDialogByType(FString type);
	...
	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_OnlineSystemUpdate(const FPICOOnUpdateStatusChangedDelegate& UpdateStatusChangedDelegate, const FPICOOnUpdateCompleteDelegate& UpdateCompleteDelegate);
	...
	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	int PXR_OfflineSystemUpdate(FString OtaFilePath, bool AutoReboot, bool ShowProgress, const FPICOOnUpdateStatusChangedDelegate& UpdateStatusChangedDelegate, const FPICOOnUpdateCompleteDelegate& UpdateCompleteDelegate);
	...
	UFUNCTION(BlueprintCallable, Category = "PXR|PXRSystemAPI")
	void PXR_ScanQRCode(const FPICOEnterpriseStringDelegate& Delegate);
};
