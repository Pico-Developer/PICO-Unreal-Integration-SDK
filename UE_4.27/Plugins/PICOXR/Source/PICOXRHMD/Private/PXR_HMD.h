...
public:
  ...
  /** FXRRenderTargetManager interface */
	...
	virtual void CalculateRenderTargetSize(FIntPoint& RenderTargetSize);
	virtual void CalculateRenderViewportSize(FIntRect& LeftViewport, FIntRect& RightViewport);
...
#ifdef PICO_CUSTOM_ENGINE
	//PICO AppSpaceWarp
	void HomeReset(FHomeResetTypes ResetType,float Yaw=0);
	void OnHMDRecentered();
	bool bAppNeedHomeReset = false;
