...
{
	FixedFoveationRendering,
	EyeTrackingFoveationRendering
};
...
UENUM()
enum class EPICOXRAdaptiveResolutionMethod : uint8
{
	Automatic UMETA(ToolTip = "Resolution is automatically adjusted based on the state of your PICO device. This considers factors such as GPU Usage, Battery, etc."),
	Manual UMETA(ToolTip = "Resolution is adjusted based on the value of the vr.PixelDensity console variable.")
};
...
public:
	...
	UPROPERTY(Config, EditAnywhere, Category = FoveationRendering, Meta = (DisplayName = "Foveation Rendering Mode"))
		EFoveationRenderingMode FoveationRenderingMode;

	UPROPERTY(Config, EditAnywhere, Category = FoveationRendering, Meta = (DisplayName = "Foveation Level"))
		TEnumAsByte<EFoveationLevel::Type> FoveationLevel;

	UPROPERTY(Config, EditAnywhere, Category = FoveationRendering, Meta = (DisplayName = "Enable Eye Tracking Foveation Rendering"))
	...
	UPROPERTY(Config, EditAnywhere, Category = AdaptiveResolution, Meta = (DisplayName = "Min Pixel Density"
		, ToolTip = "Minimum pixel density allowed for adaptive resolution. The minimum width and height will each be 1504px * [Min Pixel Density], respectively."
		, ClampMin = "0.42553191489"
		, ClampMax = "1.42553191489"))
		float PixelDensityMin = 640.f / 1504.f;

	UPROPERTY(Config, EditAnywhere, Category = AdaptiveResolution, Meta = (DisplayName = "Max Pixel Density"
		, ToolTip = "Maximum pixel density allowed for adaptive resolution. The maximum width and height will each be 1504px * [Max Pixel Density], respectively."
		, ClampMin = "0.42553191489"
		, ClampMax = "1.42553191489"))
		float PixelDensityMax = 2144.f / 1504.f;

	UPROPERTY(Config, EditAnywhere, Category = "Adaptive Resolution", Meta = (DisplayName = "Adaptive Resolution Method"
		, ToolTip = "Choose whether resolution is adjusted automatically or manually."))
		EPICOXRAdaptiveResolutionMethod AdaptiveResolutionMethod = EPICOXRAdaptiveResolutionMethod::Automatic;
	*/
