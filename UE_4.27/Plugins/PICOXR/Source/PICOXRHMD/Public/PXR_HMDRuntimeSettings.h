...
public:
	...
	UPROPERTY(Config, EditAnywhere, Category = Controller, Meta = (DisplayName = "high frequency tracking(60Hz)",EditCondition = "HandTrackingSupport==EPICOXRHandTrackingSupport::ControllersAndHands",ToolTip = "If turned on, hand tracking will run at a higher tracking frequency, which will improve the smoothness of hand tracking, but the power consumption will increase."))
	...
	UPROPERTY(Config, EditAnywhere, Category = AdaptiveResolution, Meta = (DisplayName = "Enable Adaptive Resolution"
		, ToolTip = "Choose whether resolution is enabled.\n\nNOTE: Adaptive Resolution is currently only supported on the PICO fork of Unreal Engine."))
