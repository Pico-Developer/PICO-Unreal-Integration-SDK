...
UPICOCreateAnchorEntity_AsyncAction* UPICOCreateAnchorEntity_AsyncAction::PXR_CreateAnchorEntity_Async(AActor* InBindingActor, const FTransform& InAnchorEntityTransfrom, float InTimeout)
{
	...
	Action->AnchorEntityTransform = InAnchorEntityTransfrom;
...
void UPICOCreateAnchorEntity_AsyncAction::HandleCreateAnchorEntityComplete(EPICOResult::Type Result, UPICOAnchorComponent* AnchorEntityComponent)
{
...
void UPICODestroyAnchorEntityAction::HandleDestroyAnchorEntityComplete(EPICOResult::Type Result)
{
	if (PXR_SUCCESS(Result))
	{
...
void UPICOPersistAnchorEntity_AsyncAction::HandlePersistAnchorEntityComplete(EPICOResult::Type Result, const TArray<UPICOAnchorComponent*>& AnchorList)
{
	if (PXR_SUCCESS(Result))
	{
...
void UPICOUnpersistAnchorEntity_AsyncAction::HandleUnpersistAnchorEntityComplete(EPICOResult::Type Result, const TArray<UPICOAnchorComponent*>& AnchorList)
{
	if (PXR_SUCCESS(Result))
	{
		OnSuccess.Broadcast(Result, AnchorList);
...
void UPICOClearAnchorEntity_AsyncAction::HandleClearAnchorEntityComplete(EPICOResult::Type Result)
{
	if (PXR_SUCCESS(Result))
	{
		OnSuccess.Broadcast(Result);
...
void UPICOLoadAnchorEntity_AsyncAction::HandleLoadAnchorEntityComplete(EPICOResult::Type Result, const TArray<FAnchorLoadResult>& AnchorLoadResults)
{
	if (PXR_SUCCESS(Result))
	{
...
void UPICOStartSpatialSceneCapture_AsyncAction::HandleStartSpatialSceneCaptureComplete(EPICOResult::Type Result, EPICOSpatialSceneCaptureStatus SpatialSceneCaptureStatus)
{
	if (PXR_SUCCESS(Result))
	{
