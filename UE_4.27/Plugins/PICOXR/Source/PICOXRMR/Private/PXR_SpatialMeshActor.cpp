...
void APXRSpatialMeshActor::EnableDebugFunction(bool bEnable)
{
...
int32 APXRSpatialMeshActor::GetMeshNum()
{
	return EntityToMeshMap.Num();
}

int32 APXRSpatialMeshActor::GetDrawsNum()
{
	return NumDrawCalls;
}

int32 APXRSpatialMeshActor::GetDrawnPrimitives()
{
...
{
	FColor SceneLabelColor = FColor::White;
	switch (SceneLabel)
	{
	case EPICOSemanticLabel::Unknown:
		SceneLabelColor = (FColor::White);
		break;
	case EPICOSemanticLabel::Floor:
		SceneLabelColor = (FColor::Yellow);
		break;
	case EPICOSemanticLabel::Ceiling:
		SceneLabelColor = (FColor::Blue);
		break;
	case EPICOSemanticLabel::Wall:
		SceneLabelColor = (FColor::Green);
		break;
	case EPICOSemanticLabel::Door:
		SceneLabelColor = (FColor::Purple);
		break;
	case EPICOSemanticLabel::Window:
		SceneLabelColor = (FColor::Magenta);
		break;
	case EPICOSemanticLabel::Opening:
		SceneLabelColor = (FColor::White);
		break;
	case EPICOSemanticLabel::Table:
		SceneLabelColor = (FColor::Orange);
		break;
	case EPICOSemanticLabel::Sofa:
		SceneLabelColor = (FColor::Black);
		break;
	case EPICOSemanticLabel::Chair:
		SceneLabelColor = (FColor::Cyan);
		break;
	case EPICOSemanticLabel::Human:
		SceneLabelColor = (FColor::Red);
		break;
	default: ;
	}

	return SceneLabelColor;
}
