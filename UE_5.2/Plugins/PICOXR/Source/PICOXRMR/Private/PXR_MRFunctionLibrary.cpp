...
bool UPICOXRMRFunctionLibrary::PXR_GetAnchorComponentFlags(AActor* BoundActor, TArray<TEnumAsByte<EPICOAnchorComponentTypeFlag::Type>>& OutAnchorComponentFlags)
{
