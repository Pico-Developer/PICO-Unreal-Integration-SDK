...
bool FPICOXRHMD::InitializeSession()
{
	...
	{
		//SetAppEngineInfo2
		FString UnrealSDKVersion = "UE5_3.0.5";
...
void FPICOXRHMD::PostSceneColorRenderingMobile_RenderThread(FRHICommandListImmediate& RHICmdList, FSceneView& InView)
{
...
{
	CheckInRenderThread();
	return GameSettings_RenderThread.IsValid()&&GameSettings_RenderThread->IsStereoEnabled() && bNeedReAllocateFoveationTexture_RenderThread;
}
