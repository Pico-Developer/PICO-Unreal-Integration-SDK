	...
	if (bHandTrackingAvailable)
	{
		...
		for (int Hand =0;Hand<2;Hand++)
		{
			...
			for (int Key=0;Key<4;Key++)
			{
				...
				{
					MessageHandler->OnControllerButtonPressed(HandButtons[Hand][Key], PlatformUser,DeviceId, false);
				}
				else if (HandButtonState[Hand][Key]==0&&HandButtonState[Hand][Key]!=LastHandButtonState[Hand][Key])
				{
					MessageHandler->OnControllerButtonReleased(HandButtons[Hand][Key], PlatformUser,DeviceId, false);
				}
			...
			{
				MessageHandler->OnControllerButtonPressed(HandButtons[Hand][4], PlatformUser,DeviceId, false);
			}
			else if (HandButtonState[Hand][4]==0&&HandButtonState[Hand][4]!=LastHandButtonState[Hand][4])
			{
				MessageHandler->OnControllerButtonReleased(HandButtons[Hand][4], PlatformUser,DeviceId, false);
			}
...
void FPICOXRInput::ProcessButtonAxis()
{
	...
	if (bHandTrackingAvailable)
	{
		MessageHandler->OnControllerAnalog(FPICOKeyNames::PICOHand_Left_IndexPinchStrength, PlatformUser,DeviceId, GetFingerPinchStrength(EPICOXRHandType::HandLeft,EPICOXRHandFinger::Index));
		MessageHandler->OnControllerAnalog(FPICOKeyNames::PICOHand_Left_MiddlePinchStrength, PlatformUser,DeviceId,GetFingerPinchStrength(EPICOXRHandType::HandLeft,EPICOXRHandFinger::Middle));
		MessageHandler->OnControllerAnalog(FPICOKeyNames::PICOHand_Left_PinkyPinchStrength, PlatformUser,DeviceId, GetFingerPinchStrength(EPICOXRHandType::HandLeft,EPICOXRHandFinger::Pinky));
		MessageHandler->OnControllerAnalog(FPICOKeyNames::PICOHand_Left_RingPinchStrength, PlatformUser,DeviceId, GetFingerPinchStrength(EPICOXRHandType::HandLeft,EPICOXRHandFinger::Ring));
		MessageHandler->OnControllerAnalog(FPICOKeyNames::PICOHand_Left_ThumbClickStrength, PlatformUser,DeviceId, GetClickStrength(EPICOXRHandType::HandLeft));
		MessageHandler->OnControllerAnalog(FPICOKeyNames::PICOHand_Right_IndexPinchStrength, PlatformUser,DeviceId, GetFingerPinchStrength(EPICOXRHandType::HandRight,EPICOXRHandFinger::Index));
		MessageHandler->OnControllerAnalog(FPICOKeyNames::PICOHand_Right_MiddlePinchStrength, PlatformUser,DeviceId,GetFingerPinchStrength(EPICOXRHandType::HandRight,EPICOXRHandFinger::Middle));
		MessageHandler->OnControllerAnalog(FPICOKeyNames::PICOHand_Right_PinkyPinchStrength, PlatformUser,DeviceId, GetFingerPinchStrength(EPICOXRHandType::HandRight,EPICOXRHandFinger::Pinky));
		MessageHandler->OnControllerAnalog(FPICOKeyNames::PICOHand_Right_RingPinchStrength, PlatformUser,DeviceId, GetFingerPinchStrength(EPICOXRHandType::HandRight,EPICOXRHandFinger::Ring));
		MessageHandler->OnControllerAnalog(FPICOKeyNames::PICOHand_Right_ThumbClickStrength, PlatformUser,DeviceId, GetClickStrength(EPICOXRHandType::HandRight));
	}
}
...
void FPICOXRInput::RegisterKeys()
{
	...
	AddNonExistingKey(ExistAllKeys,FKeyDetails(FPICOTouchKey::PICOHand_Left_ThumbClickStrength, LOCTEXT("PICOHand_Left_ThumbClickStrength", "PICO Hand (L) Thumb Click Strength"), FKeyDetails::GamepadKey | FKeyDetails::Axis1D| FKeyDetails::NotBlueprintBindableKey, "PICOHand"));
	AddNonExistingKey(ExistAllKeys,FKeyDetails(FPICOTouchKey::PICOHand_Left_IndexPinchStrength, LOCTEXT("PICOHand_Left_IndexPinchStrength", "PICO Hand (L) Index Pinch Strength"), FKeyDetails::GamepadKey | FKeyDetails::Axis1D| FKeyDetails::NotBlueprintBindableKey, "PICOHand"));
	AddNonExistingKey(ExistAllKeys,FKeyDetails(FPICOTouchKey::PICOHand_Left_MiddlePinchStrength, LOCTEXT("PICOHand_Left_MiddlePinchStrength", "PICO Hand (L) Middle Pinch Strength"), FKeyDetails::GamepadKey | FKeyDetails::Axis1D| FKeyDetails::NotBlueprintBindableKey, "PICOHand"));
	AddNonExistingKey(ExistAllKeys,FKeyDetails(FPICOTouchKey::PICOHand_Left_RingPinchStrength, LOCTEXT("PICOHand_Left_RingPinchStrength", "PICO Hand (L) Ring Pinch Strength"), FKeyDetails::GamepadKey | FKeyDetails::Axis1D| FKeyDetails::NotBlueprintBindableKey, "PICOHand"));
	AddNonExistingKey(ExistAllKeys,FKeyDetails(FPICOTouchKey::PICOHand_Left_PinkyPinchStrength, LOCTEXT("PICOHand_Left_PinkyPinchStrength", "PICO Hand (L) Pinky Pinch Strength"), FKeyDetails::GamepadKey | FKeyDetails::Axis1D| FKeyDetails::NotBlueprintBindableKey, "PICOHand"));

	AddNonExistingKey(ExistAllKeys,FKeyDetails(FPICOTouchKey::PICOHand_Right_ThumbClickStrength, LOCTEXT("PICOHand_Right_ThumbClickStrength", "PICO Hand (R) Thumb Click Strength"), FKeyDetails::GamepadKey | FKeyDetails::Axis1D| FKeyDetails::NotBlueprintBindableKey, "PICOHand"));
	AddNonExistingKey(ExistAllKeys,FKeyDetails(FPICOTouchKey::PICOHand_Right_IndexPinchStrength, LOCTEXT("PICOHand_Right_IndexPinchStrength", "PICO Hand (R) Index Pinch Strength"), FKeyDetails::GamepadKey | FKeyDetails::Axis1D| FKeyDetails::NotBlueprintBindableKey, "PICOHand"));
	AddNonExistingKey(ExistAllKeys,FKeyDetails(FPICOTouchKey::PICOHand_Right_MiddlePinchStrength, LOCTEXT("PICOHand_Right_MiddlePinchStrength", "PICO Hand (R) Middle Pinch Strength"), FKeyDetails::GamepadKey | FKeyDetails::Axis1D| FKeyDetails::NotBlueprintBindableKey, "PICOHand"));
	AddNonExistingKey(ExistAllKeys,FKeyDetails(FPICOTouchKey::PICOHand_Right_RingPinchStrength, LOCTEXT("PICOHand_Right_RingPinchStrength", "PICO Hand (R) Ring Pinch Strength"), FKeyDetails::GamepadKey | FKeyDetails::Axis1D| FKeyDetails::NotBlueprintBindableKey, "PICOHand"));
	AddNonExistingKey(ExistAllKeys,FKeyDetails(FPICOTouchKey::PICOHand_Right_PinkyPinchStrength, LOCTEXT("PICOHand_Right_PinkyPinchStrength", "PICO Hand (R) Pinky Pinch Strength"), FKeyDetails::GamepadKey | FKeyDetails::Axis1D| FKeyDetails::NotBlueprintBindableKey, "PICOHand"));
}
